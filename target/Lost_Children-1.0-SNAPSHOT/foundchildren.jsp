<%-- 
    Document   : foundchildren
    Created on : Jun 14, 2018, 3:13:58 PM
    Author     : eslam java
--%>
        ...
        <h1 style="padding-left:50%;padding-top: 30px;padding-bottom: 20px"> Found Children</h1>
            ...
            <div style="padding-top: 20px;padding-left: 40px" algin="center">
                ...
                <c:forEach items="${foundChildren}" var="found" >  
                    ...
                    <tr>
                        <td><img src="<c:out value="${found.imageUrl}"/>" style="width: 150px;height: 150px;padding-top: 20px"/></td>
                        <td>${found.firstName}</td> 
                        <td>${found.lastName}</td>
                        <td>${found.motherName}</td>
                        <td>${found.gender}</td>
